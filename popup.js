document.addEventListener('DOMContentLoaded', function() {
    const currencyList = [
        ...
        "BHD (Bahraini Dinar)", "BIF (Burundian Franc)", "BMD (Bermudian Dollar)", "BND (Brunei Dollar)", "BOB (Bolivian Boliviano)", "BRL (Brazilian Real)",
        "BSD (Bahamian Dollar)", "BTN (Bhutanese Ngultrum)", "BWP (Botswana Pula)", "BYN (Belarusian Ruble)", "BZD (Belize Dollar)", "CAD (Canadian Dollar)",
        "CDF (Congolese Franc)", "CHF (Swiss Franc)", "CLP (Chilean Peso)", "CNY (Chinese Yuan)", "COP (Colombian Peso)", "CRC (Costa Rican Colón)",
        ...
        "FKP (Falkland Islands Pound)", "FOK (Faroese Króna)", "GBP (British Pound Sterling)", "GEL (Georgian Lari)", "GGP (Guernsey Pound)",
        ...
        "ILS (Israeli New Shekel)", "IMP (Isle of Man Pound)", "INR (Indian Rupee)", "IQD (Iraqi Dinar)", "IRR (Iranian Rial)", "ISK (Icelandic Króna)",
        ...
        "TOP (Tongan Paʻanga)", "TRY (Turkish Lira)", "TTD (Trinidad and Tobago Dollar)", "TVD (Tuvaluan Dollar)", "TWD (New Taiwan Dollar)", "TZS (Tanzanian Shilling)",
        "UAH (Ukrainian Hryvnia)", "UGX (Ugandan Shilling)", "UYU (Uruguayan Peso)", "UZS (Uzbekistani Som)", "VES (Venezuelan Bolívar)", "VND (Vietnamese Dong)",
